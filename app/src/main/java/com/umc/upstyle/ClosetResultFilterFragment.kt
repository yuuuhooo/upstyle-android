...
import com.umc.upstyle.databinding.FragmentClosetResultFilterBinding

class ClosetResultFilterFragment : Fragment() { // 주석 처리한 코드는 이전 구현 때 사용했던 코드들인데 다음 기능을 추가할 때 필요할 수 있는 코드들이라 삭제하지 않은 코드들입니다.

    private var _binding: FragmentClosetResultFilterBinding? = null
...
//    private var selectedColor: String? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentClosetResultFilterBinding.inflate(inflater, container, false)
        return binding.root
    }
